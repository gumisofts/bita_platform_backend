...
class IndustryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Media"), {"fields": ("image",), "classes": ("collapse",)}),
        (
            _("Timestamps"),
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("id", "name", "industry", "is_active")}),
        (_("Media"), {"fields": ("image",), "classes": ("collapse",)}),
        (
            _("Timestamps"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
...
class AddressAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("id", "lat", "lng", "plus_code")}),
        (
            _("Address Details"),
...
class BusinessAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("id", "name", "business_type", "owner")}),
        (_("Location & Categories"), {"fields": ("address", "categories")}),
        (_("Media"), {"fields": ("background_image",), "classes": ("collapse",)}),
        (
            _("Timestamps"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class BusinessActivityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("id", "business", "employee")}),
        (_("Activity Details"), {"fields": ("model", "action")}),
