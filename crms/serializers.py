...
class GiftCardTransferSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ['gift_card', 'from_customer',
                            'to_customer', 'transferred_at']
    ...
    def validate(self, attrs):
        ...
        if gift_card.current_owner != from_customer:
            raise serializers.ValidationError(
                "This customer does not own gift card")
    ...
    def create(self, validated_data):
        ...
        return GiftCardTransfer.objects.create(gift_card=gift_card,
