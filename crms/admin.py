...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ("id", "email", "full_name", "phone_number", "business_name", "gift_card_count", "created_at")
...
class GiftCardAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('id', 'value', 'status', 'card_type')
        }),
        (_('People'), {
            'fields': ('created_by', 'issued_by', 'current_owner')
        }),
        (_('Products'), {
            'fields': ('products',),
            'classes': ('collapse',)
...
class GiftCardTransferAdmin(admin.ModelAdmin):
    list_display = ("id", "gift_card_value", "from_customer_info", "to_customer_info", "created_at")
    ...
    fieldsets = (
        ...
        (_('Transfer Details'), {
            'fields': ('from_customer', 'to_customer')
        }),
        (_('Timestamps'), {
            'fields': ('created_at',),
            'classes': ('collapse',)
