...
class OrderAdmin(admin.ModelAdmin):
    list_display = ["id", "customer_info", "employee_info", "status", "total_payable", "item_count", "created_at"]
    ...
    fieldsets = (
        (None, {
            'fields': ('id', 'customer_id', 'employee_id', 'status')
        }),
        (_('Financial'), {
...
class OrderItemAdmin(admin.ModelAdmin):
    list_display = ["id", "order_id", "item_name", "item_business", "quantity", "order_status", "created_at"]
