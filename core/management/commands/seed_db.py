        ...
        for business in businesses:
            for role_name in role_names:
                ...
                role_permissions = random.sample(
                    list(all_permissions), random.randint(1, 5)
                )
        ...
        for business in businesses:
            ...
            for _ in range(num_employees):
                ...
                employee = Employee.objects.create(
                    ...
                    branch=(
                        random.choice(business_branches) if business_branches else None
                    ),
                )
                ...
                if group.name in item_data:
                    ...
                    for i in range(num_items):
                        ...
                        if business_categories:
                            item_categories = random.sample(
                                business_categories,
                                random.randint(1, min(2, len(business_categories))),
                            )
