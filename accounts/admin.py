...
class CustomUserAdmin(BaseUserAdmin):
    ...
    def verification_status(self, obj):
        ...
        return format_html(
            f'Email: {email_status} | Phone: {phone_status}'
        )
...
class UserDeviceAdmin(admin.ModelAdmin):
    ...
    search_fields = ["user__email", "user__first_name", "user__last_name", "label", "fcm_token"]
    readonly_fields = ["id", "created_at", "updated_at"]
    raw_id_fields = ["user"]
    
    fieldsets = (
        (None, {
            'fields': ('id', 'user', 'label', 'fcm_token')
        }),
        (_('Timestamps'), {
...
class VerificationCodeAdmin(admin.ModelAdmin):
    list_display = ["id", "user_info", "contact_method", "is_used", "expires_at", "created_at"]
    list_filter = ["is_used", "expires_at", "created_at"]
    search_fields = ["user__email", "user__phone_number", "email", "phone_number", "code"]
    readonly_fields = ["id", "code", "created_at", "expires_at"]
    raw_id_fields = ["user"]
    
    fieldsets = (
        (None, {
            'fields': ('id', 'user', 'code', 'is_used')
        }),
